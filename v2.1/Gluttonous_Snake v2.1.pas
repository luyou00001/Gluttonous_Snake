...
var i,j,k,l,choice,map_num,slength,score,speed,direction,enlarge,multiple,total,tx,ty,item_num:longint;
    ...
    die,pe,pw,acceleration,ssnake,sarea,continue,newmap:Boolean;
...
begin
     ...
     textbackground(8);
     textcolor(7);
     gotoxy(21,6);write('  Gluttonous Snake v2.1 by Sen Sen                          ');
...
begin
     textbackground(8);
     textcolor(7);
     gotoxy(21,3);write('             Gluttonous Snake v2.1  by SUN CHOI             ');
     gotoxy(1,1);
     textbackground(11);
     ...
     for i:= 1 to 30 do
         for j:= 1 to 30 do
             begin
                  ...
                  gotoxy(i*2+19,j+4);
                  if map[map_num].area[i,j]<10 then write(0,map[map_num].area[i,j])
                     else write(map[map_num].area[i,j]);
             end;
end;
...
begin 
     ...
     if key=#27 then map[map_num]:=temp;
     ClearSnake;
     SaveSnake;
     ShowSnake;
     ShowRight;
...
begin
     writeln('Gluttonous Snake v2.1  by SUN CHOI');
     ...
     textbackground(8);
     textcolor(7);
     gotoxy(21,2);write('             Gluttonous Snake v2.1  by SUN CHOI             ');
     ReadData; 
     choice:=1;
     repeat
           ClearScreen;
